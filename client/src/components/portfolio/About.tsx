...
const strengths = [
  { icon: Code2,  title: "JS & TypeScript",  desc: "Primary languages. I build full‑stack apps with strong typing and modern tooling." },
  { icon: Layers, title: "Full Stack MERN",   desc: "MongoDB, Express, React, Node.js — from auth flows to REST APIs and database design." },
  { icon: Zap,    title: "Founder Mindset",   desc: "I combine product thinking with execution — building Towlips while shipping software." },
];

const education = [
  { degree: "Diploma",  institution: "Govt. Polytechnic College, Mananthavady", year: "2024" },
  { degree: "SSLC",     institution: "S.N.M.H.S.S. Parappanangadi, Kerala",     year: "2021" },
];
    ...
    <section id="about" style={{ borderBottom: "1px solid var(--m-border)" }}>
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "0 20px" }}>
        ...
        <div className="m-page-header">
          <p className="m-label" style={{ marginBottom: 6 }}>01. About Me</p>
